...
#Get Users for a course_number
    ...
    print('Two args for this program.')
    print('python Canvas_Enroll_Student_Into_Another_Class.py Arg1 Arg2')
    print('Arg1 is the source class SIS ID')
    print('Arg2 is the destination class SIS ID')
    print('Example would be')
    print('python Canvas_Enroll_Student_Into_Another_Class.py 022112 021114')
#for index, row in df.iterrows():
