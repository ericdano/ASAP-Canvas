...
def get_asapconnected_enrollments(accesstoken):
...
def look_for_new_enrollments()
    

Set_globals()
accesstoken = get_asapconnected_token()
results = get_asapconnected_enrollments(accesstoken)
