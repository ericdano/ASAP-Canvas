...
if len(sys.argv) < 4:
    print('Script needs three arguments: python name.csv "term" "teacher@mail.com')
    exit(0)
newcoursecode = sys.argv[1]
    ...
    try:
        ...
        if str(e) == "Not Found":
            ...
            newCourse = subaccount.create_course(
                                ...
                                'sis_course_id': newcoursecode,
                                'term_id': term_id}
                                )
            print(newCourse)
            dmsgbody = dmsgbody + 'created course ' + newcoursecode + ' in Canvas\n'
            copy_to_new_course()
